...
data modify entity @s Item.components."custom_data".ghostcraft.type set value "frag_grenade"
data modify entity @s Item.components."custom_model_data".strings set value ["ghost_frag_grenade"]
