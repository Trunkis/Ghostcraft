...
execute store result score @s ghostcraft.temp run data get entity @s Passengers[0].Item.components."custom_data".ghostcraft.thrower_uuid
...
particle item{item:"bone"} ~ ~ ~ 0 0 0 0.05 5 force @a[tag=ghostcraft.item.scare.thrower]
