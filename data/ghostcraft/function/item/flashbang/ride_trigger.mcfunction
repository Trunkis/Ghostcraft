...
data modify entity @s Item.components."custom_data".ghostcraft.type set value "flashbang"
data modify entity @s Item.components."custom_model_data".strings set value ["ghost_flashbang"]
