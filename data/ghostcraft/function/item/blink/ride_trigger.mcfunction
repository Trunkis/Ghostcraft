...
execute store result score item.blink.ride_trigger.thrower_uuid ghostcraft.temp run data get entity @s Item.components."custom_data".ghostcraft.thrower_uuid
