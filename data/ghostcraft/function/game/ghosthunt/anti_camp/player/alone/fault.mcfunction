...
execute as @e[type=vex,tag=ghostcraft.game.ghosthunt.anti_camp.vex.new] at @s run data modify entity @s last_hurt_by_player set from entity @e[type=#ghostcraft:player,limit=1,tag=ghostcraft.game.ghosthunt.anti_camp.current] UUID
